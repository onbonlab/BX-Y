...
{
    public partial class DynamicFile : Form
    {
        ...
        private void btn_addBMP_Click(object sender, EventArgs e)
        {
            string szFileName;
            OpenFileDialog openFileDialog1 = new OpenFileDialog();
            openFileDialog1.Filter = "所有支持文件|*.bmp;*.jpg;*.png";
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                szFileName = openFileDialog1.FileName;
                listBox1.Items.Add(szFileName);
                LedYSDK.DynamicAreaFile DynamicAreaFile;
                DynamicAreaFile.m_dynamic_type=0;
                ...
                DynamicAreaFile.m_file_path=szFileName;
        ...
        private void btn_addTXT_Click(object sender, EventArgs e)
        {
            string szFileName;
            OpenFileDialog openFileDialog1 = new OpenFileDialog();
            openFileDialog1.Filter = "所有支持文件|*.txt";
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                szFileName = openFileDialog1.FileName;
                listBox1.Items.Add(szFileName);
